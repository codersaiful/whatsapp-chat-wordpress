...
class Helper {
	...
	public static function printWorkingDays( $array_data ) {
		if ( $array_data['isAlwaysAvailable'] === 'ON' ) {
			return __( 'Always online', 'codeastrology-whatsapp' );
		}

		$date_string = '';
		$daysOfWeek  = array(
			'sunday'    => __( 'Sunday', 'codeastrology-whatsapp' ),
			'monday'    => __( 'Monday', 'codeastrology-whatsapp' ),
			'tuesday'   => __( 'Tuesday', 'codeastrology-whatsapp' ),
			'wednesday' => __( 'Wednesday', 'codeastrology-whatsapp' ),
			'thursday'  => __( 'Thursday', 'codeastrology-whatsapp' ),
			'friday'    => __( 'Friday', 'codeastrology-whatsapp' ),
			'saturday'  => __( 'Saturday', 'codeastrology-whatsapp' ),
		);
	...
	public static function checkGDPR( $option ) {
		...
		if ( isset( $_COOKIE['cat-wa-gdpr'] ) && $_COOKIE['cat-wa-gdpr'] == 'accept' ) {
			return false;
		}
		return true;
	}
	...
	public static function print_icon() {
		return '<svg width="48px" height="48px" class="cat-whatsapp-default-avatar" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
