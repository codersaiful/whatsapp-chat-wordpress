<table class="form-table" id="app-design">
    ...
    <tbody>
        <tr class="setting widget-type">
            <th scope="row"><label for=""><?php echo __('Widget Type', 'codeastrology-whatsapp') ?></label></th>
            <td>
        ...
        <tr class="setting widget-text">
            <th scope="row"><label for="title"><?php echo __('Widget Text', 'codeastrology-whatsapp') ?></label></th>
        ...
        <tr class="setting widget-label-text <?php echo ($option['isShowBtnLabel'] === 'ON' ? '' : 'hidden') ?>">
            <th scope="row"><label for="btnLabel"><?php echo __('Widget Label Text', 'codeastrology-whatsapp') ?></label></th>
        ...
        <tr class="setting widget-label-width <?php echo ($option['isShowBtnLabel'] === 'ON' ? '' : 'hidden') ?>">
            <th scope="row"><label for="btnLabelWidth"><?php echo __('Widget Label Width(px)', 'codeastrology-whatsapp') ?></label></th>
            <td>
        ...
        <tr class="setting text-color">
            <th scope="row"><label for="textColor"><?php echo __('Widget Text Color', 'codeastrology-whatsapp') ?></label></th>
        ...
        <tr class="setting background-color">
            <th scope="row"><label for="backgroundColor"><?php echo __('Widget Background Color', 'codeastrology-whatsapp') ?></label></th>
        ...
        <tr class="setting widget-distance">
            <th scope="row"><label for=""><?php echo __('Widget Distance', 'codeastrology-whatsapp') ?></label></th>
            <td>
        ...
        <tr class="setting widget-powered-by">
            <th scope="row"><label for=""><?php echo __('Powered-by Label', 'codeastrology-whatsapp') ?></label></th>
            <td>
                <div class="cat-wa-switch-control" style="margin-top: 5px;">
        ...
        <tr class="setting response-text">
            <th scope="row"><label for="responseText"><?php echo __('Response Time Text', 'codeastrology-whatsapp') ?></label></th>
            <td>
                <?php wp_editor($option['responseText'], 'responseText', $editor_settings); ?>
            </td>
        </tr>
        <tr class="setting description">
            <th scope="row"><label for="wp-description-wrap"><?php echo __('Description', 'codeastrology-whatsapp') ?></label></th>
            <td>
                <?php wp_editor($option['description'], 'description', $editor_settings_quicktags); ?>
            </td>
        </tr>
        <tr class="setting gdpr-content">
            <th scope="row"><label for="gdprContent"><?php echo __('GDPR Notice', 'codeastrology-whatsapp') ?></label></th>
            <td>
                <div class="cat-wa-switch-control" style="margin-top: 5px;">
                    <input type="checkbox" id="cat-wa-switch-gdpr" name="isShowGDPR" <?php checked($option['isShowGDPR'], 'ON') ?>>
                    <label for="cat-wa-switch-gdpr" class="green"></label>
                </div>
                <br />
                <div id="cat-gdpr-editor" class="<?php echo ($option['isShowGDPR'] === 'ON' ? '' : 'hidden') ?>">
