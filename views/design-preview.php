...
<script type="text/template" id="widget-preview">
    ...
    <div class="wa__popup_content wa__popup_content_left">
        ...
        <% if (settings.isShowGDPR) { %>
            <div class="cat-wa-gdpr"><input id="cat-wa-gdpr" type="checkbox" value="accept">
                <label for="cat-wa-gdpr"><%= settings.gdprContent %></label>
            </div>
            <% }  
        %>
        <div class="wa__popup_content_list">
            ...
            <div class="wa__popup_content_item">
                <a class="wa__stt <%= account.status === 'online' ? 'wa__stt_online' : 'wa__stt_offline' %>">
                    ...
                    <% } else { %>
                        <div class="wa__popup_avatar cat-default-avt">
