<div class="meta-button-style">
    <div class="design-button" id="button-design">
        <table class="form-table">
            <p><?php echo __('This styling applies only to the shortcode buttons for this account. Leave blank to use the default styles.', 'codeastrology-whatsapp') ?></a></p>
            <tbody>
                <tr>
                    <th scope="row">
                        <label for="label"><?php echo __('Button Label', 'codeastrology-whatsapp') ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php echo __('This text applies only on shortcode button.', 'codeastrology-whatsapp') ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="type"><?php echo __('Button Style', 'codeastrology-whatsapp') ?></label></th>
                    <td>
                        <div class="setting align">
                            <div class="button-group button-large" data-setting="align">
                                <button class="button btn-round <?php echo ($buttonStyles['type'] == 'round' ? 'active' : '') ?>" value="round" type="button">
                                    <?php echo __('Round', 'codeastrology-whatsapp') ?>
                                </button>
                                <button class="button btn-square <?php echo ($buttonStyles['type'] == 'square' ? 'active' : '') ?>" value="square" type="button">
                                    <?php echo __('Square', 'codeastrology-whatsapp') ?>
                                </button>
                            </div>
                ...
                <tr>
                    <th scope="row"><label for="backgroundColor"><?php echo __('Button Background Color', 'codeastrology-whatsapp') ?></label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="textColor"><?php echo __('Button Text Color', 'codeastrology-whatsapp') ?></label></th>
                    <td>
        ...
        <a href="javascript:;" class="wa__stt_online wa__button <%= buttonStyles.buttonClass %>">
            <% if (_.isEmpty(buttonStyles.avatar)) { %>
                <div class="wa__btn_icon">
                    <img src="<?php echo CAT_WHATSAPP_PLUGIN_URL ?>assets/img/whatsapp_logo.svg" alt="img"/>
                </div>
            <% } else { %>
            ...
            <% if (!_.isEmpty(buttonStyles.title)) { %>
                <div class="wa__cs_info">
                    ...
                    <div class="wa__cs_status"><?php echo  __('Online', 'codeastrology-whatsapp') ?></div>
                </div>
            <% } %>
